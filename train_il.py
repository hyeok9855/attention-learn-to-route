...
from utils.log_utils import log_values_il
...
def train_epoch(model, optimizer, lr_scheduler, epoch, training_dataset, val_dataset, tb_logger, opts):
...
def train_batch(
    ...
    cost, log_likelihood = model(x, pi_expert=pi_expert)
    ...
    if step % int(opts.log_step) == 0:
        log_values_il(cost, grad_norms, epoch, batch_id, step,
